...
async function careersMail (data){
    return `<!DOCTYPE html>
    <html>
        <head>
            <meta charset="utf-8">
            <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <title>New candidate ${data.name} applied for the job</title>
        ...
        <body>
           ...
           <td width="30%">
            ...
            <td width="40%">
                ...
                <h1 style="color: #0166e7;">New Candidate Applied For the Job</h1>
                <span class="borderline"></span>
            </div>
            <div style="padding: 20px;margin-top: 30px;margin-right: 10%;padding-bottom: 40px;">
                <p><strong style="color: #00356c;">From Dronevala AI</strong></p>
                <p>Hello Team! I bought you an update, ${data.name}  applied for a postion ${data.position} his contact details are email : ${data.email} , phone: ${data.number} and his resume is Added below Please have a look towards it</p>
                <p>Thanking You</p>
                <p>Dronevala AI</p>
