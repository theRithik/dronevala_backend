function AdminqueryMail (data){
    return `<!DOCTYPE html>
    <html>
        <head>
            <meta charset="utf-8">
            <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <title>New query request from ${data.name}</title>
        ...
        <body>
           ...
           <td width="30%">
            ...
            <td width="40%">
                ...
                <h1 style="color: #0166e7;">New Query Request</h1>
                <span class="borderline"></span>
            </div>
            <div style="padding: 20px;margin-top: 30px;margin-right: 10%;padding-bottom: 40px;">
                <p><strong style="color: #00356c;">From Agmay AI</strong></p>
                <p>Hello Team! I bought you an update, ${data.name} has raised a request to contact, his contact details are email : ${data.email} , phone: ${data.phone}, and his message is ${data.query} </p>
