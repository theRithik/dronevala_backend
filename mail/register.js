...
function RegisterMail(data){
   ...
   <p>Verify your email by clicking on this  <a href="https://dronevala.com/users/verify/${data.token}" target="_blank" rel='noopener noreferrer'><button class="buttonReg">Verify</button></a></p>
